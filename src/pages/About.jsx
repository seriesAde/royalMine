            ...
            <div className="mt-5 w-[90%] lg:w-[85%] mx-auto ">
                <div className="bg-[url('https://www.royalminesproperty.com/static/media/banner2.f10821a5f9d035f5b5a2.avif')] bg-cover w-full bg-no-repeat bg-center " style={{ backgroundAttachment: "fixed" }}>
                    <div className="w-[55%] mx-auto pb-10 md:px-10">
                        ...
                        <div className="rounded-2xl bg-[#7a4b04d2] p-3  text-white text-sm lg:text-base font-bold mb-5 text-center text-pretty">
                ...
                <div className="mt-5 py-5 bg-gray-100 md:px-10 lg:px-40">
                    <h1 className="text-3xl lg:text-4xl font-bold capitalize text-[#007BFF] text-center mt-5">our mission</h1>
                ...
                <div className=" py-5 bg-gray-100 px-3 md:px-10 lg:px-50">
                    <h1 className="text-3xl lg:text-4xl font-bold capitalize text-[#007BFF] text-center mt-5">our vision</h1>
                ...
                <div className="p-5">
                    <div className="border border-gray-300 rounded-lg mt-5 p-1">
                        <div className="p-5">
                            <h1 className="capitalize font-bold text-3xl lg:text-4xl text-[#0E2E50]">who we are</h1>
